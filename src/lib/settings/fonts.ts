...
export const FONTS: FontEntry[] = [
    ...
    },
    {
        ...
        cssFamily: '"iA Writer Quattro", system-ui, sans-serif',
        category: "Sans-Serif",
        group: "Sans",
        docFeatured: false,
        uiFeatured: false,
        ...
        desc: "Information Architects' custom font, designed from the ground up for their writing app. A proportional sans-serif that prioritizes comfort over long writing sessions. The letterforms are carefully spaced to reduce eye fatigue and keep you in the text. If you've used iA Writer and loved how it felt to type in it, this is why.",
    },
    {
        name: "Calibri",
