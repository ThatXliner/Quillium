...
export const FONTS: FontEntry[] = [
    ...
    },
    {
        ...
        uiFeatured: false,
        uiFont: false,
        desc: "Google's answer to a workhorse digital serif. Mechanically precise, optimized for readability across screen sizes and resolutions. Less personality than Lora or Garamond, but that can be a feature: it stays out of the way and lets the writing do the work.",
    },
    {
    ...
    },
    {
        ...
        uiFeatured: false,
        uiFont: false,
        desc: "Luc(as) de Groot designed Calibri for Microsoft in 2004, and it became the Office default in 2007. Slightly warmer than Arial, with softer rounded terminals that make it less cold on screen. If you wrote a lot in Word, your eye is already calibrated to this — that muscle memory is real.",
    },
    {
        name: "Verdana",
