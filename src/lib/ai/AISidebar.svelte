...
<div class="w-[400px] h-screen flex flex-col border-r border-gray-200 bg-white">
    {#if action === null}
        <!-- Main menu -->
        <div class="p-4 border-b border-gray-200">
            ...
            <div class="space-y-3">
                ...
                >
                    ...
                    <div class="text-sm text-blue-600">Ask questions about your document</div>
                </button>
                ...
                >
                    ...
                    <div class="text-sm text-green-600">Receive suggestions for improvement</div>
                </button>
                ...
                >
                    <div class="font-medium text-purple-900">Revise & Rewrite</div>
                    <div class="text-sm text-purple-600">Improve flow and conciseness</div>
                </button>
            </div>
        </div>
        ...
        <div class="p-4">
            <div class="text-xs text-gray-500 space-y-2">
                <div>Document: {$documentContent ? `${$documentContent.length} characters` : 'No content'}</div>
                {#if $selectedText}
                    <div class="bg-yellow-50 p-2 rounded border border-yellow-200">
                        <div class="font-medium text-yellow-800">Selected:</div>
                        <div class="text-yellow-700">"{$selectedText.slice(0, 100)}{$selectedText.length > 100 ? '...' : ''}"</div>
                    </div>
                {/if}
            </div>
        </div>
    ...
    {:else if action === "chat"}
        ...
        <div class="flex items-center p-4 border-b border-gray-200">
            <button onclick={goBack} class="mr-3 text-gray-500 hover:text-gray-700">
                ← Back
            </button>
