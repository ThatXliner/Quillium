      ...
      createSuggestion: tool({
        ...
        inputSchema: z.object({
          targetText: z
            .string()
            .describe(
              "The exact text to revise. Make sure to keep this as small as possible. Avoid multiple changes in one suggestion",
            ),
          replacements: z
            .array(
              z.object({
  ...
  const { object } = await generateObject({
    ...
    schema: z.object({
      goal: z
        .string()
        .describe(
          "What this piece of writing needs to accomplish — the core purpose or objective",
        ),
      tone: z
        .string()
        .describe(
          "The voice, register, and emotional quality the writing should have",
        ),
      audience: z
        .string()
        .describe("Who will read this and what they're looking for"),
      emphasize: z
        .string()
        .describe(
          "What to foreground — themes, qualities, arguments, or details that should be prominent",
        ),
      avoid: z
        .string()
        .describe(
          "Common pitfalls, off-tone moves, or things that would undermine this piece",
        ),
      notes: z
        .string()
        .describe(
          "Any other important context, constraints, or strategic considerations",
        ),
    }),
