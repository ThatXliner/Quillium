...
bun run relay:build
bun packages/relay/dist/index.js
```
...
```sh
docker build -f packages/relay/Dockerfile -t quillium-relay .
docker run --env-file packages/relay/.env -p 3001:3001 quillium-relay
```
