# Quillium — The Non-Linear Writing App

Source: https://quillium.bryanhu.com
...
| `extracted/tokens.json` | Design tokens: 20 colors, 3 fonts, 10 headings, 3 CTAs |
...
- **Colors**: #000000 (bg-dark), #F5F4F1 (bg-light), #3B82F6 (accent), #FFFFFF (bg-light), #A855F7 (accent), #FFFEFB (bg-light), #2563EB (accent), #22C55E (accent), #2C2622 (surface-dark), #FAF9F7 (bg-light)
- **Fonts**: Inter (300,400,500,600,700), Newsreader (400,500), Georgia (400)
