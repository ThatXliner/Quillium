...
description: >
  ...
  identical and sacred — the five-tone warm-stone palette, Inter 400 + Inter, the
...
typography:
  ...
  # — display / hero ramp (Newsreader 400, sentence case) —
  h3:          { fontFamily: "Newsreader", cqw: 1.8, weight: 400, lineHeight: 1.1 }
  timeline-headline:{ fontFamily: "Newsreader", cqw: 1.9, weight: 400, lineHeight: 1.1 }
  card-headline:{ fontFamily: "Newsreader", cqw: 2.0, weight: 400, lineHeight: 1.15 }
  stat-figure: { fontFamily: "Newsreader", cqw: 3.0, weight: 400, lineHeight: 1.0 }
  quote-mark:  { fontFamily: "Newsreader", cqw: 9.0, weight: 400, lineHeight: 0.5, color: "line" }
  h2:          { fontFamily: "Newsreader", cqw: 4.0, weight: 400, lineHeight: 1.1 }
  h1:          { fontFamily: "Newsreader", cqw: 6.2, weight: 400, lineHeight: 1.06 }
  display:     { fontFamily: "Newsreader", cqw: 8.0, weight: 400, lineHeight: 1.04 }
...
- **Fonts** — set to **Newsreader** (display) / **Inter** (body), matching Quillium's landing page; ignore any preset font name lingering in prose.
...
The voice is a literary pairing: **Inter** at weight 400 (the thin-stroke didone, never
...
- **Inter 400** (ink, sentence case) for display; **Inter** body (gray) + labels (taupe, tracked).
...
- **Inter + Inter via Google Fonts.** CJK pairing (Noto Serif SC 700/400) carries over; Playfair has no Hanzi italic — substitute weight/taupe for emphasis.
