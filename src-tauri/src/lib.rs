...
use db::{
    ...
    schema::open_db,
    tabs::{
        create_tab, delete_draft, delete_tab, fork_draft, get_active_draft, get_active_tab,
        list_tab_drafts, list_tabs, rename_draft, rename_tab, set_active_draft, set_active_tab,
        set_draft_locked,
    },
