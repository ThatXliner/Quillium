...
- [ ] **Phase 1: Test Harness & Invariants** — Deterministic two-peer test infrastructure + canonical-source invariants land before any sync rewrite.
- [ ] **Phase 2: Joiner View Hardening** — Joiner collab view has no `history()`, empty initial annotationField, and re-entrance-guarded owner seed.
...
| 1. Test Harness & Invariants | v1.1 | 0/? | Not started | - |
| 2. Joiner View Hardening | v1.1 | 0/? | Not started | - |
